...
const Footer = () => {
  return (
    ...
    <section className="w-full h-[380px] relative ">
        ...
        ></div>
        <Image src="/help.png" alt="help-image" fill objectFit="contain" />

        <div className="container px-5 lg:px-12  absolute top-[50%] transform translate-y-[-50%] left-[30%] translate-x-[-30%] flex items-center justify-between">
          ...
          <div className="w-full lg:w-1/2 flex items-end justify-start flex-col ">
            <button
      ...
      <div className="container">
        ...
        <section className="flex flex-col gap-5 p-5 text-text_link_light capitalize">
          <div className=" w-full flex items-start justify-between gap-5">
            <ul className="w-full md:w-1/2 xl:w-1/3 leading-10 text-sm">
              <li>head office</li>
              <li>
            ...
            <ul className="w-full md:w-1/2 xl:w-1/3 leading-8 text-sm">
              <li>product</li>
              <li>new arrival</li>
              <li>living room</li>
            ...
            <div className="w-full md:w-1/2 xl:w-1/3 leading-5 text-sm">
              ...
              <p>
                ...
                maiores sed placeat dicta asperiores facilis, corrupti suscipit
                et at odit ipsum officiis eum architecto assumenda. Dolores
                porro velit a eaque?
              </p>
            </div>
          </div>
