...
const WriteAbout = () => {
  return (
    <section className="container my-10 p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
      <div className="w-full md:w-[85%]">
        <h2 className="font-bold my-3 text-text_black uppercase text-[35px] tracking-[5px]">
          FURNITURE TO WRITE HOME ABOUT
        </h2>
        <p className="text-sm font-300 my-3 text-[20px] leading-8 tracking-[1px]">
      ...
      <div className="relative w-full md:w-[100%] h-[400px]">
        <Image
